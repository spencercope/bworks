    ...
    sendEmail(templateName, to, from, data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.isTemplateExist(templateName)) {
                throw new common_1.InternalServerErrorException(`Template not found ${templateName}`);
            }
            const emailData = yield this.prepareTemplate(templateName, data);
            if (typeof (to).toString().toLowerCase() === 'object') {
                to = to.join(' ');
            }
            const emailOptions = {
                message: Object.assign({ to }, emailData),
            };
